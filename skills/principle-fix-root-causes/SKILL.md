...
- Check for the pattern, not just the instance. Fix matching instances inside the authorized scope; report material matches outside it rather than silently expanding the task.
