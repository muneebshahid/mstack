...
External consumers, rolling deployments, independently released components, and contractual compatibility can require a migration window. In those cases, make the compatibility period explicit, observable, owned, and scheduled for deletion rather than pretending the surface is closed.
