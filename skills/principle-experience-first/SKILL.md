...
Foundations should serve the experience, not the other way around. [Model the Domain](../principle-model-the-domain/SKILL.md) governs foundational structure and [Sequence Verifiable Units](../principle-sequence-verifiable-units/SKILL.md) governs delivery order; this principle governs the target experience.
