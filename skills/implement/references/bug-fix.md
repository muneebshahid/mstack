...
- Read [Explain](../../explain/SKILL.md) mechanics to trace the affected runtime flow and boundaries. Read Explain rationale for regression history, prior incidents, tickets, or design constraints when those sources could discriminate among causes.
