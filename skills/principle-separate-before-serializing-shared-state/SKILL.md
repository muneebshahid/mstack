...
**Foundational test:** Before sharing state between actors, ask: "What happens if another actor modifies this concurrently?" If the answer is not "nothing," isolate ownership or define structural coordination before implementation spreads.
