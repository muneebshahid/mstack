...
This is not merely a thought experiment. During planning, be ruthless about identifying when the current shape is wrong for the requirement and recommend the redesign before implementation begins. Once the target is accepted, deliver it in verifiable increments rather than preserving the old shape through permanent compatibility code.
